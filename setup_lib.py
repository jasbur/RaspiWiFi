...
def copy_configs():
	...
	os.system('sudo cp -a /usr/lib/raspiwifi/reset_device/static_files/dnsmasq.conf /etc/')
	os.system('sudo cp -a /usr/lib/raspiwifi/reset_device/static_files/hostapd.conf /etc/hostapd/')
	os.system('sudo mv /etc/dhcpcd.conf /etc/dhcpcd.conf.original')
	os.system('sudo cp -a /usr/lib/raspiwifi/reset_device/static_files/dhcpcd.conf /etc/')
	os.system('mkdir /etc/cron.raspiwifi')
	os.system('sudo cp -a /usr/lib/raspiwifi/reset_device/static_files/aphost_bootstrapper /etc/cron.raspiwifi')
