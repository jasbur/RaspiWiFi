...
def copy_configs():
	...
	os.system('cp -a /usr/lib/raspiwifi/reset_device/static_files/dnsmasq.conf /etc/')
	...
	os.system('cp -a /usr/lib/raspiwifi/reset_device/static_files/dhcpcd.conf /etc/')
	os.system('mkdir /etc/cron.raspiwifi')
	os.system('cp -a /usr/lib/raspiwifi/reset_device/static_files/aphost_bootstrapper /etc/cron.raspiwifi')
